...
const home: Home = {
  ...
  subline: (
    <>
    I'm Imre, a media design student at <Text as="span" size="xl" weight="strong">METU</Text>, where I learn about art and technology. <br /> In the mean time I build my own projects.
</>
  ),
};
